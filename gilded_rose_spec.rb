...
describe GildedRose do
  ...
  describe "#update_quality" do
    ...
    xit "will degrade standard items twice as fast after expiry" do
    ...
    xit "will never decrease quality below 0" do
    ...
    xit "will never increase an item's quality above 50" do
    ...
    xit "will not decrease quality or sell_in for Sulfuras, Hand of Ragnaros" do
    ...
    xit "will increase the quality of Aged Brie the older that it gets" do
    ...
    xit "will increase the quality of Backstage passes to a TAFKAL80ETC concert by 2 when 10 days or less until sell_in date" do
    ...
    xit "will increase the quality of Backstage passes to a TAFKAL80ETC concert by 3 when 5 days or less until sell_in date" do
    ...
    xit "will decrease the quality of Backstage passes to a TAFKAL80ETC concert to 0 after the sell_in date has passed" do
